...
export default function Topbar({ onMenuClick }: TopbarProps) {
  ...
  return (
    <header className={`sticky top-0 z-30 backdrop-blur-xl ${theme === 'light' ? 'bg-white/95 border-b border-black/[0.06] shadow-sm shadow-black/[0.06]' : 'bg-[#0a0a0a]/80 border-b border-white/[0.06]'}`}>
